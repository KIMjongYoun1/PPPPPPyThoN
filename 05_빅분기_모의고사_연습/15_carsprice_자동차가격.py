...
# [유형] 빅분기 실기 2유형(모델링) — 숫자 맞추기·회귀 (연습: carsprice)
# ============================================================
#
# ┌─ [문제 목표] ─────────────────────────────────────────────
# │  차량 정보로 **가격(price)** 을 숫자로 예측한다.
# └──────────────────────────────────────────────────────────
#
# ┌─ [제공 데이터] (학습/시험 이미 분리) ─────────────────────
# │  경로: BASE/carsprice/ — 파일명 **대문자 X_train.csv** 등 주의
# │  ┌──────────────┬────────────────────────────────────────
# │  │ X_train.csv  │ 학습 입력
# │  │ y_train.csv  │ **price**
# │  │ X_test.csv   │ 시험 입력
...
#
# ┌─ [수행 요구사항] ─────────────────────────────────────────
# │  ① ID 분리. ② `y_train["price"]`. ③ 전처리 후 **회귀** 모델.
# └──────────────────────────────────────────────────────────
#
# ┌─ [제출 산출물] ───────────────────────────────────────────
...
# TODO: X_train = pd.read_csv(f"{BASE}/carsprice/X_train.csv")
# TODO: X_test = pd.read_csv(f"{BASE}/carsprice/X_test.csv")
# TODO: y_train = pd.read_csv(f"{BASE}/carsprice/y_train.csv")
# TODO: y_test = pd.read_csv(f"{BASE}/carsprice/y_test.csv")
